...
class MainWindow(QMainWindow):
    ...
    def _build_central_widget(self) -> None:
        ...
        self._casting_controller = CastingController(self._device_manager, device_panel, screen_panel)
        performance_slider.valueChanged.connect(self._casting_controller.set_slider_value)
        self._camera_controller = CameraController(self._device_manager, device_panel)
        self._mic_controller = MicController(self._device_manager, device_panel)
