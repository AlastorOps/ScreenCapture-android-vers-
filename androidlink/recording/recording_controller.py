...
class RecordingController(QObject):
    ...
    def _on_cast_session_started(self, width: int, height: int, fps: int) -> None:
    ...
    def _start_recording(self) -> None:
        ...
        self._recorder.start(path, self._frame_width, self._frame_height, self._fps)
